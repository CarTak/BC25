package Aulas.poo.correcao; // dentro do pacote "aulas" está o pacote "correção"
// e dentro de "correção" esta a classe Correção1
...
//        entrada.userLocale(Locale.US);
        ...
        switch (opcao){ // o swicth melhorado elimina o break
            case 1 -> {
